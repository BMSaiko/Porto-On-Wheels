        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">
                        Here you can see every Partners in your database
                    </p>
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2>Manage <b>Partners</b></h2>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="#addScooterModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Partners</span></a>
                                        </div>
                                    </div>
                                </div>
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $partners = $db->query('select id, name, image from partners')->fetchAll();
                                        foreach ($partners as $partner) {
                                            echo '<tr>
                                            <td>' . $partner["name"] . '</td>

                                            <td class="text-right">
                                                <a href="#editPartnerModal" class="edit" data-toggle="modal" data-attribute-id="' . $partner["id"] . '" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                <a href="#deletePartnerModal" class="delete" data-toggle="modal" data-attribute-id="' . $partner["id"] . '" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                            </td>
                                        </tr>';
                                        }
